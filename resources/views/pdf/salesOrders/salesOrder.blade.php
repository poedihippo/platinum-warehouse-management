                        ...
                        <table class="table-border-radius">
                            ...
                            <tr>
                                <td class="border-right-bottom-dashed py-3">
                                    ...
                                    <p class="mx-5 m-0 ml-20">
                                        {{ date('d M Y', strtotime($salesOrder->shipment_estimation_datetime)) }}</p>
                                </td>
                                <td class="border-left-bottom-dashed py-3">
        ...
        <table style="width: 100%; border: 1px solid" cellspacing="0">
            ...
            @foreach ($salesOrder->details as $detail)
                <tr>
                    ...
                    <td class="border-right text-right">
                        <span class="mx-5">{{ rupiah($detail->unit_price) }}</span>
                    </td>
                    <td class="border-right">
                    ...
                    <td class="text-right">
                        <span class="mx-5">{{ rupiah($detail->total_price) }}</span>
                    </td>
                </tr>
            @endforeach
            <tr>
                        ...
                        <tr>
                            <td>
                                <div class="border border-radius-8">
                                    <p class="mx-5 my-5">{{ $spellTotalPrice ?? rupiah($salesOrder->price) }}</p>
                                    <br>
                                </div>
                            </td>
                        </tr>
                ...
                <td style="width: 35%; vertical-align: top;">
                    <table class="table-border-radius">
                        <tr>
                            ...
                            <td class="width-50 border-bottom text-right py-3">
                                <span class="mr-5">{{ rupiah($salesOrder->details->sum('total_price')) }}</span>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table class="mt-5 table-border-radius">
                        <tr>
                            ...
                            <td class="width-50 text-right py-3">
                                <span class="mr-5">{{ rupiah($salesOrder->shipment_fee) }}</span>
                            </td>
                        </tr>
                    </table>
                    <table class="mt-5 table-border-radius">
                        <tr>
                            ...
                            <td class="width-50 text-right text-bold py-3">
                                <span class="mr-5">{{ rupiah($salesOrder->price) }}</span>
                            </td>
                        </tr>
                    </table>
                </td>
