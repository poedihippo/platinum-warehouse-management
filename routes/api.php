...
Route::middleware(['auth:sanctum', 'ability:warehouse'])->group(function () {
    ...
    Route::put('product-units/{productUnit}/update-relations/{id}', [ProductUnitController::class, 'updateProductUnitRelations']);
    ...
    Route::group(['prefix' => 'delivery-orders/{deliveryOrder}/details'], function () {
        ...
        Route::get('{deliveryOrderDetail}/items', [DeliveryOrderDetailController::class, 'items']);
    ...
    Route::apiResource('stocks', StockController::class)->only(['index', 'show', 'update', 'destroy']);
